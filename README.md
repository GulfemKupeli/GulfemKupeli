...
Final-year Computer Engineering student @ **İzmir Katip Çelebi University** (2021–2026), graduating soon. Building at the intersection of mobile development, applied AI, and human-centered design.

🎓 **Google AI & Technology Academy** — Scholarship Recipient (Nov 2024 – Aug 2025)  
✈️ **Erasmus Exchange** — West Pomeranian University of Technology, Szczecin (Mar – Jul 2025)
...
`Flutter` `Firebase` `Gemini API` `Dart`
...
`React` `TypeScript` `Capacitor` `Supabase` `Gemini`
...
```json
{
  "mobile":    ["Flutter", "Provider", "Bloc", "Firebase", "RESTful APIs"],
  "languages": ["Python", "Dart", "Java", "C", "SQL"],
  "ai_ml":     ["Gemini API", "Scikit-learn", "RoBERTa", "Deep Learning", "NLP", "spaCy"],
  "design":    ["Figma", "Procreate", "UI/UX Principles", "HCI"],
  "tools":     ["Git", "GitHub", "Android Studio", "VS Code", "Django"]
}
```
...
| Program | Issuer | Date |
|---|---|---|
| **Google Project Management** — 7-course professional certificate | Google / Coursera | Jul 2025 · [Verify ↗](https://coursera.org/verify/professional-cert/5LQT8D59XXXH) |
| **Advanced Python, ML & AI Bootcamp** | Pupilica | Dec 2024 – Jan 2025 |
| **Backend & API Development with Python** (Django) | BTK Academy | 2024 |
...
<div align="center">
  ...
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/GulfemKupeli/GulfemKupeli/output/dist/github-snake-dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/GulfemKupeli/GulfemKupeli/output/dist/github-snake.svg">
    <img alt="Gülfem's Contribution Snake" src="https://raw.githubusercontent.com/GulfemKupeli/GulfemKupeli/output/dist/github-snake.svg">
  </picture>
</div>
